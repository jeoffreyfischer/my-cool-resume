    ...
    <div className="cv-page bg-slate-900">
      ...
      <div className={`cv-square ${!activeSection ? 'cv-main-page' : ''}`}>
        ...
        <div className="cv-quarter-hover-layer" aria-hidden="true">
          <img
            src={`${import.meta.env.BASE_URL}images/jeo-to-the-left-removebg.png`}
            alt=""
            className="cv-quarter-hover-image cv-quarter-hover-image--education"
          />
          <img
            src={`${import.meta.env.BASE_URL}images/jeo-to-the-right-removebg.png`}
            alt=""
            className="cv-quarter-hover-image cv-quarter-hover-image--career"
          />
          <img
            src={`${import.meta.env.BASE_URL}images/jeo-happy-removebg.png`}
            alt=""
            className="cv-quarter-hover-image cv-quarter-hover-image--media"
          />
          <img
            src={`${import.meta.env.BASE_URL}images/jeo-sad-removebg.png`}
            alt=""
